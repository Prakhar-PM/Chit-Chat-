    ...
    <div className='min-h-screen bg-cover bg-center flex items-center justify-center gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <h2 className='font-medium text-2xl flex items-center justify-between'>
        ...
        {currState === 'Sign up'&& !isDataSubmitted &&(
          ...
          type="text" className='p-2 vorder border-gray-500 rounded-md focus:outline-none'
...

        {
          currState === 'Sign up' && isDataSubmitted &&(
            ...
            rows ={4} className='p-2 border border-fray-500 
            rounded-mdfocus:outline-none focus:ring-2 focus:ring-indigo-500'
             placeholder='provide ashort bio...' required></textarea>
          )
        }
