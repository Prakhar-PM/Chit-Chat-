           ...
           <div className='relative py-2 group'>
              ...
              bg-[#282142] border border-gray-600 text-gray-100 hidden
                      group-hover:block'>
                            ...
                            <hr className='my-2 border-t order-gray-500' />
                            <p className='cursor-pointer text-sm'>logout</p>
                        </div>
           </div>
        </div>
        <div className=' flex items-center gap-2 bg-[#282142] px-4 py-3 mt-5 rounded-full'>
      ...
      <div className='flex flex-col'>
          {userDummyData.map((user,index)=>(
            ...
            cursor-pointer max-sm:text-sm ${selectedUser?._id === user._id && 'bg-[#282142]/50'}`}>
                <img src={user?.profilePic || assets.avatar_icon} alt="text" className = 'w-[35px] aspect-[1/1] rounded-full'/>
